...
//        
//        let comment = Comment(commentId, commentText, String(commentAuthorUid), eventPostId)
...
//        NotificationService.postNotification(forNotification: CommentNotification(commentedPostId: eventPost.eventPostID, userUid: String(commentAuthor.uid), seen: false, forUserUid: String(eventPost.event.host.uid), notificationId: comment.commentId), withUpdates: updates) { finalUpdates in
